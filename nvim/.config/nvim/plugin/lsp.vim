...
nnoremap <silent> <leader>lwd  <cmd>lua require('telescope.builtin').lsp_workspace_diagnostics()<CR>
nnoremap <silent> <leader>ldd  <cmd>lua require('telescope.builtin').lsp_document_diagnostics()<CR>
